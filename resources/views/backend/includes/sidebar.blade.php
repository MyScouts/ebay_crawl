<div class="c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show" id="sidebar">
    <div class="c-sidebar-brand d-lg-down-none">
        ...
        <strong>
            <span class="h4 text-uppercase">{{ __(appName()) }}</span>
        </strong>
    </div>
    <!--c-sidebar-brand-->
    ...
    <ul class="c-sidebar-nav">
        ...
        @if ($logged_in_user->hasAllAccess() || $logged_in_user->hasRole('publish-product'))
            <li class="c-sidebar-nav-item">
                <x-utils.link class="c-sidebar-nav-link" :href="route('admin.products.list')" :active="activeClass(Route::is('admin.products.list'), 'c-active')"
                    icon="c-sidebar-nav-icon cil-car-alt" :text="__('Products')" />
            </li>
        @endif
